...
| US | Issue | Titel | Status |
|----|-------|-------|--------|
| US-7.00 | #527 | Bootstrap: AXIA-schema laden | ⬜ open |
| US-7.01 | #528 | AXIA-perspectief registreren | ⬜ open |
| US-7.02 | #529 | Waardekaart laden + fix axia:concernsValueType | ⬜ open |
| US-7.03 | #530 | ValueClaim aanmaken via waardepalet | ⬜ open |
| US-7.04 | #531 | ValueTensionClaim aanmaken | ⬜ open |
